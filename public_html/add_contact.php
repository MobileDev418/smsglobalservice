<?php
	...
	$menu=14;
	/* Form to add new contact into address book. */
?>
<?php
            ...
            <table width="100%">
                <tr>
                 ...
                 <tr>
                    ...
                    <td width="38%" align="left"><input name="phone" type="text" id="phone" class="text" onkeypress="return isNumberKey(event)" maxlength="15" /></td><td width="26%" align="left"><span class="invalid" id='er_phone'><img src="images/cross.png" alt=""></span></td>
                    </tr>
                <tr>
