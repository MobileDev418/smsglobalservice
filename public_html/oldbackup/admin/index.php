...
<table align="center" cellpadding="0" cellspacing="0" id="admin_table">
  ...
  <tr>
    ...
    <div style="margin-top:30px">
      ...
      <p><a href="routesms.php"><img src="images/routesms.png" alt="Manage RoutSms"  border="0" id="Image2" onMouseOver="MM_swapImage('Image2','','images/routesms-over.png',1)" onMouseOut="MM_swapImgRestore()" /></a>&nbsp;<!--<a href="credit.php"><img src="images/credit_detail.png" alt="Credit Left"  border="0" id="Image4" onMouseOver="MM_swapImage('Image4','','images/credit_detail-over.png',1)" onMouseOut="MM_swapImgRestore()" /></a>--><a href="contactus_messages.php"><img src="images/crownsms.png" width="220" height="48" id="Image3" onMouseOver="MM_swapImage('Image3','','images/crownsms-over.png',1)" onMouseOut="MM_swapImgRestore()" border="0"></a></p>
      <p><a href="credit.php"></a>&nbsp;<a href="phone_directory.php"><img src="images/ph_directory.png" alt="Phone Directory" border="0" width="220" height="48" id="Image8" onMouseOver="MM_swapImage('Image8','','images/ph_directory-over.png',1)" onMouseOut="MM_swapImgRestore()">&nbsp;</a><a href="history.php"><img src="images/todays_sms.png" name="Image10" width="220" height="48" border="0" id="Image10" onMouseOver="MM_swapImage('Image10','','images/todays_sms_over.png',1)" onMouseOut="MM_swapImgRestore()"></a></p>
      <p><a href="delivry.php"><img src="images/sms_delivry.png" width="220" height="48" border="0" id="Image11" onMouseOver="MM_swapImage('Image11','','images/sms_delivry_over.png',1)" onMouseOut="MM_swapImgRestore()"></a><a href="changepassword.php">&nbsp;<img src="images/ch_password.png" alt="Change Password" border="0" id="Image6" onMouseOver="MM_swapImage('Image6','','images/ch_password-over.png',1)" onMouseOut="MM_swapImgRestore()"  /></a> </p>
      <p><a href="signout.php" onClick="return confirm('Are you sure to sign-out?')">&nbsp;<img src="images/sign_out.png" alt="Sign Out"  border="0" id="Image7" onMouseOver="MM_swapImage('Image7','','images/sign_out-over.png',1)" onMouseOut="MM_swapImgRestore()" /></a>&nbsp;   </p>
    </div></td>
  </tr>
</table>
</body>
