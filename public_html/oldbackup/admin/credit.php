...
$credit_url="http://121.241.242.116:8080/chkcredit?username=".$api->username."&password=".$api->password;
...
<tr>
	<td height="30" align="center" style="color:#990000; font-size:18px; font-weight:bold"><?php echo $credit;?>
	  </td>
</tr>
<tr>
