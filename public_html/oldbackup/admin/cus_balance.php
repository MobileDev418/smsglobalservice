...
<table width="297" align="center" cellpadding="0" cellspacing="0" id="admin_table">
<tr>
    <td width="295" class="crown_head"><?php echo $WEBSITE; ?> - Customer Balance</td>
  </tr>
<tr>
  <?php
...
<tr>
	<td height="30" colspan="2" align="center"><input type="submit" value="Update Credits" class="submit"/>&nbsp;<input type="button" onClick="window.location='showpaypalpayment.php?id=<?php echo $id; ?>&name=<?php echo $_GET['name']; ?>'" value="Pay Pal Payment" class="submit"/>&nbsp;<input type="button" value="Cancel" class="submit" onClick="window.location='customers.php'" /></td>
</tr>
</form>
</table>
</td>
