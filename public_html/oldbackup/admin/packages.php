...
<tr class="topheading">
    ...
    <td width="218" align="left" >Package Name</td>
    <td width="218" align="left" >SMS Limit</td>
...
if($packages)
{
	...
	{	
		...
		$package_name="<a href='#' onclick='showEdit(".$ind.",\"".$pack->package."\",\"".$pack->amount."\",\"".$pack->description."\")' class='edname' />".$pack->package. "</a>";
		if($pack->publish==1)
		...
		echo "<td align='left'>".$pack->sms_lower."-".$pack->sms_upper."</td>";
...
<tr>
	...
	<td width="182" height="26" align="right" >Lower Limit *</td>
	 <td width="142"><input type="text" maxlength="20" id='lowelimit' name="lower_limit" class="textbox" /></td>
	<td width="160" align="left">&nbsp;</td>
</tr>

<tr>
	 
	<td width="182" height="26" align="right" >Upper Limit *</td>
	 <td width="142"><input type="text" maxlength="20" id='decrption' name="upper_limit" class="textbox" /></td>
	<td width="160" align="left">&nbsp;</td>
</tr>
<tr>
...
<tr class="topheading" height="29px">
	<td colspan="2" align="center">Update Package</td>
</tr>
