...
$_SESSION['total_cus_his_rec']=$db->get_var("select count(*) from history where cus_id=".$id." and sms_date >='".$lower."' and sms_date <='".$upper."'");
...
if($_POST['exporttoexcel']==1) //Check that admin requested for excel report
		{
			...
			include_once "../admin/export_report_smshistroy_member.php";
		}
