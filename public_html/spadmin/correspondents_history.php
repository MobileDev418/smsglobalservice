...
$q="select * from clients_correspondents where spid=".$_SESSION['sp_adminid']." and corres_dt >='".$lower."' and corres_dt <='".$upper."' order by corres_dt desc";

//Get the total records to do paging

$_SESSION['total_cus_his_rec']=$db->get_var("select count(*) from clients_correspondents where spid=".$_SESSION['sp_adminid']." and corres_dt >='".$lower."' and corres_dt <='".$upper."'");
...
if($_POST['exporttoexcel']==1) //Check that admin requested for excel report
		{
			...
			include_once "../admin/export_report_clientcorrespondents.php";
		}
...
<tr class="topheading" style="font-size:11px; font-weight:normal">
    ...
    <th width="324" align="left" >Comments</th>
