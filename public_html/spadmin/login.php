...
//Login form for admin to sign in admin control panel
?>
<html>
<head>
...
<table width="100%" align="center"  cellpadding="2px"  cellspacing="2px" class="admin_table">
  <form method="post" action="sign_spadmin.php">
    <tr class="topheading" height="29px">
      <td colspan="2" align="center">Sales Person - Administrator</td>
    </tr>
    <tr>
