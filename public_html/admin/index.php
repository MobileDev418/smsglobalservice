...
<body onLoad="MM_preloadImages('images/packages-over.png','images/routesms-over.png','images/correspondents.png','images/customers-over.png','images/sign_out-over.png','images/credit_detail-over.png','images/ph_directory-over.png','images/crownsms-over.png','images/todays_sms_over.png','images/ch_password-over.png','images/sms_delivry_over.png'),'images/salespersonlog-over.png')'">
<table align="center" cellpadding="0" cellspacing="0" id="admin_table">
  ...
  <tr>
    ...
    <div style="margin-top:30px">
      ...
      <p><a href="contactus_messages.php"><img src="images/crownsms.png" width="220" height="48" id="Image3" onMouseOver="MM_swapImage('Image3','','images/crownsms-over.png',1)" onMouseOut="MM_swapImgRestore()" border="0"></a>&nbsp;<a href="phone_directory.php"><img src="images/ph_directory.png" alt="Phone Directory" border="0" width="220" height="48" id="Image8" onMouseOver="MM_swapImage('Image8','','images/ph_directory-over.png',1)" onMouseOut="MM_swapImgRestore()"></a></p>
      ...
      <p><a href="correspondents.php"><img src="images/correspondents.png" alt="Correspondents" name="Image20" width="220" height="48" border="0" id="Image20" onMouseOver="MM_swapImage('Image20','','images/correspondents-over.png',1)" onMouseOut="MM_swapImgRestore()"></a>&nbsp;<a href="salesperson_actionlog.php"><img src="images/salespersonlog.png" alt="Sales Person Actions Log" border="0" id="Image21" onMouseOver="MM_swapImage('Image21','','images/salespersonlog-over.png',1)" onMouseOut="MM_swapImgRestore()"  /></a>
