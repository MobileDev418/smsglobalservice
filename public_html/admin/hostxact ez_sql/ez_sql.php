<?php
	...
	define("EZSQL_DB_USER", "brain_mehreen");			// <-- mysql db user
	define("EZSQL_DB_PASSWORD", "pakistan");		// <-- mysql db password
	define("EZSQL_DB_NAME", "brain_smsglobal");		// <-- mysql db pname
