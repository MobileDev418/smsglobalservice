...
//File is used to display current routesms api url, username and password. admin can change api information. Form submiited calls save_routsms.php file to update new api info
?>
<html>
<head>
