...
$q="insert into package (pack_id, package, cost,sms_lower,sms_upper, description, publish,buynowlink) values(".$newid.",'".$name."','".$amount."',".$lowersms.",".$uppersms.",'".$descrption."',1,'".$buynowlink."')";
$db->query($q);
