...
function showEdit(edname,nm,amt,desc,buynowlink,lrange,urange)
{
	var viewdiv=document.getElementById('viewdiv');
	var newdiv=document.getElementById('newdiv');
    var eddiv=document.getElementById('eddiv');
...
var snlower=document.getElementById('new_sms_lower'); 
var snupper=document.getElementById('new_sms_upper'); var snbuynow=document.getElementById('new_buynow');
	viewdiv.style.visibility='hidden';
	newdiv.style.visibility='hidden';
	...
	snm.value=nm;
	samt.value=amt;
	sdesc.value=desc; snlower.value=lrange; snupper.value=urange; snbuynow.value=buynowlink;
