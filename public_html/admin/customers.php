...
$q="select * from customer where cus_id!=0";
...
<form method="post" action="customers.php">
	...
	?>
	>No</td>
	 <td style="text-align:right">Sales Person Status</td><td><input type="radio" name="c_issp"
	<?php if($scissp=="2")
	echo 'checked="checked"';
	?>

	value="2">All&nbsp;&nbsp;<input type="radio" name="c_issp" value="1" 	
	<?php if($scissp=="1")
	echo 'checked="checked"';
	?> >Yes&nbsp;&nbsp;<input type="radio" name="c_issp" value="0" 	
	...
	<tr><td style="text-align:right">Managed by Sales Person</td>
	<td>
