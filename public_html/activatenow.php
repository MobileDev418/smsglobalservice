...

{
	...
	$activation_message="Hello ".$cus->fname."! your activation code for ".$WEBSITE_NAME." is ".$cus->activation_code." and username is ".$cus->username." Please activate your account. Thanks";
