<div class="formdiv">
<div style="display:none;color:red; text-align:left;font-size:125%;font-weight:bold;margin:5px 0 5px 0px;" id="insufficentbalancediv"><div style="background:#000;color:#ff0000;font-size:20px;padding:10px;text-align:center">Insufficient credits!</div></div>
...

		{
...

			{
...

				{
					...
					echo "<tr class='in_sufficent' align='left'><td colspan='4'>Insufficient credits!</td></tr>";
					?>
