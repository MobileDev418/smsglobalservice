<?php
	...
	/* File to send bulk sms. User uploads a text file with list of numbers, enters other fileds of the form and submits the form  */
?>
...
<div class="formdiv">
	<div style="width:550px; margin:auto;">
     <div class="note">
       <div class="typo-icon">Attached a txt file of mobile numbers (Maximum 10000), seperated by line. <br />
      Download <a href="demonumbers.txt">Sample File</a></div></div>
