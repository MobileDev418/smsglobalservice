...
<div class="formdiv">
	...
	?>
        <table cellpadding="0" cellspacing="0" class="grid" width="100%">
            ...
            <tr><td style="font-weight:bold; text-align:right">Address:</td><td  class="caption"><?php echo $cus->address ?></td></tr>
            <tr><td style="font-weight:bold; text-align:right">Sender's ID:</td><td  class="caption"><?php echo $cus->mobile ?></td></tr>
