<?php
	...
	/* File send message to contacts list. This file is included in contacts_sms.php */
	...
	$lnamelist="";
	$customlist=="";
	/* ids are calculated from contacts_sms.php file that includes this file to send sms */
	...
	{
		$i=1;
		foreach($phones as $ph) /* Loop to create a list of names and mobils of contacts submitted by customer to send sms */
		{
			if($i!=1)
			{
				$phlist.=",";	
