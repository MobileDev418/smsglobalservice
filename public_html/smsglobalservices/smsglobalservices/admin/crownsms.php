...
<table align="center" cellpadding="2" cellspacing="2" class="admin_table">
    ...
    <tr><td align="center" colspan="4"><input type="submit" name="showhistory" value="Show Messages" class="submit"  />
    &nbsp; <input type="button" value="Cancel" class="submit" onClick="window.location='customers.php'" /></td></tr>
    </form>
    </table>
