<?php
	...
	define("EZSQL_DB_USER", "smsgloba_sms");			// <-- mysql db user
	define("EZSQL_DB_PASSWORD", "pakistan@123");		// <-- mysql db password
	define("EZSQL_DB_NAME", "smsgloba_globalsms");		// <-- mysql db pname
