...
//This files shows the data interval to display sms_delivery report. Form calls show_sms_delivry.php file to display report
?>

<html>
<head>
<title><?php echo $ADMIN_TITLE; ?> - SMS Delivery Status</title>
...
<table align="center" cellpadding="2" cellspacing="2" class="admin_table">
    ...
    <tr><td align="center" colspan="4"><input type="submit" name="showhistory" value="SMS Delivery" class="submit"  />
    &nbsp; <input type="button" value="Cancel" class="submit" onClick="window.location='index.php'" /></td></tr>
    </form>
    </table>
